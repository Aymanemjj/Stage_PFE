...
export default function League() {
    ...
    return (
        <div className="p-8 space-y-6">
            <div>
                <h2 className="text-large font-semibold">League</h2>
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className="col-span-2 flex flex-col gap-4">
                    ...
                    <div className="border border-border rounded-2xl p-6">
                        <div className="flex justify-between items-start">
                            <div>
                                <h3 className="font-semibold">Current League</h3>
                        ...
                        <p className="text-4xl font-bold mt-4">Gold <span className="text-2xl font-normal text-muted">League</span></p>
                        <div className="grid grid-cols-3 mt-6 pt-4 border-t border-border text-small">
                            <div>
                            ...
                            <div>
                                ...
                                <p className="font-semibold mt-1">11-40</p>
                            </div>
                            <div>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="border border-border rounded-2xl p-6 space-y-3">
                        <h3 className="font-semibold">All Leagues</h3>
                        {leagues.map(l => (
                            <div key={l.name} className={`flex items-center gap-3 p-3 rounded-xl ${l.active ? "bg-primary-normal/10 border border-primary-normal/30" : ""}`}>
                                ...
                                <div>
                                    <p className="text-small font-semibold">{l.name}</p>
                    ...
                    <div className="border border-border rounded-2xl p-6 bg-primary-normal/5 space-y-3">
